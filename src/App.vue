...
<footer class="px-3 py-8 bg-gray-800 text-2 text-gray-200 transition-colors duration-200">
    <div class="flex flex-col">
        ...
        <div class="mt-4 md:mt-0 flex flex-col md:flex-row">
            <nav class="flex-1 flex flex-col items-center justify-center md:items-end md:border-r border-gray-100 md:pr-5">
                <router-link @click="topFunction" to="/Blood-Donors" class="text-white">
                    Home
                </router-link>
            ...
            <div class="mt-4 md:mt-0 flex-1 flex items-center justify-center md:border-r border-gray-100">
                <a class="hover:text-primary-gray-20" href="https://github.com/Mufassir-Chowdhury/Blood-Donors">
                    <span class="sr-only">
                        View on GitHub
                    </span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="text-xl hover:text-white transition-colors duration-200" viewBox="0 0 1792 1792">
                ...
                <router-link to="/Blood-Donors/edit" class="ml-4 hover:text-primary-gray-20" href="#">
                    <span class="sr-only">
                        Settings
                    </span>
                    <svg width="30" height="30" fill="currentColor" class="text-xl hover:text-white transition-colors duration-200" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="mt-7 md:mt-0 flex-1 flex flex-col items-center justify-center md:items-start md:pl-5">
                ...
                <span class="mt-7 md:mt-1">
                    Created by
                    <a class="underline hover:text-primary-gray-20" href="https://www.linkedin.com/in/mufassir-Chowdhury/">
                        MAC
                    </a>
                </span>
            </div>
